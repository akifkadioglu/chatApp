...
func Init() gorm.DB {
	...
	db.AutoMigrate(&models.User{}, &models.Contact{}, &models.Message{}, &models.Language{}, &models.UserLanguage{}, &models.Country{}, &models.UserCountry{}, &models.Block{}, &models.Group{}, &models.GroupUser{})
	if err != nil {
		panic(err.Error())
	}
	return *db
